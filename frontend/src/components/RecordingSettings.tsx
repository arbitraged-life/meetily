...
export function RecordingSettings({ onSave }: RecordingSettingsProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {preferences.auto_save && (
        <div className="space-y-4">
          <div className="p-4 border border-gray-200 dark:border-gray-800 rounded-lg bg-gray-50 dark:bg-gray-900">
            ...
            <div className="text-sm text-gray-600 dark:text-gray-300 mb-3 break-all">
              {preferences.save_folder || 'Default folder'}
            </div>
            <button
              onClick={handleOpenFolder}
              className="flex items-center gap-2 px-3 py-2 text-sm border border-gray-300 dark:border-gray-700 rounded-md hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
            >
      ...
      {!preferences.auto_save && (
        <div className="p-4 border border-yellow-200 dark:border-yellow-900/50 rounded-lg bg-yellow-50 dark:bg-yellow-900/20">
      ...
      <div className="space-y-4">
        <div className="border-t border-gray-200 dark:border-gray-800 pt-6">
          <h4 className="text-base font-medium text-gray-900 dark:text-gray-100 mb-4">Default Audio Devices</h4>
